...
struct Test {
	...
	//Polimorf
	bool test_polymorh();
	bool test_tree_create_test();
	bool test_delete_node_with_children();
	bool test_find_none_null();
	bool test_find_null();

	//Template
	bool test_template_tree_create_test();
	bool test_template_find();
	bool test_template_delete_node_with_children();
	bool test_template_delete_tree();
};