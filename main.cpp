...
void testingHeirClass() { //Наследники
	Test test;
...
void testingTemplClass() {
	Test test;
	cout << "Test 1 " << test.test_template_tree_create_test() << "\n";
	cout << "Test 2 " << test.test_template_find() << "\n";
	cout << "Test 3 " << test.test_template_delete_node_with_children() << "\n";
	cout << "Test 4 " << test.test_template_delete_tree() << "\n";
	cout << "Successful: " << test.success3 << "/" << "4\n";
	cout << "Failed: " << test.fail3 << "\n\n\n";
}
...
int main() {
	//testingMainClass(); // Lab 1_2_3
	//Info();
	//testingHeirClass(); //Lab 4
	//testingPolymorh(); //Lab 5
	//Exeptions(); //Lab 6
	testingTemplClass(); //Lab 7
	//testingTemp(); //Lab 8
	cin.get();
}